...
import { fetchBalance,updateBalance } from "../API/balance";
...
export const fetchRemoteBalanceAction = createAsyncThunk('balance/fetchBalance',
async(action)=>{
...
export const updateRemoteBalanceAction = createAsyncThunk('balance/updateBalance',
async(payload)=>{
  console.log('payload', payload)
  const response = await updateBalance(payload.entryId,payload.quantity)
